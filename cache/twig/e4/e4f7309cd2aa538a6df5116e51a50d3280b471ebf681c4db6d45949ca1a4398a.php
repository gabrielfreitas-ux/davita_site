...
class __TwigTemplate_02d07c33c0dc925d8d5e178867af30f883284a198186817e1e7d8651b5bee8bb extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute(($context["field"] ?? null), "title", array())) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 5
                echo $this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "title", array()));
            } else {
                // line 7
    ...
    ";
        ...
        if ($this->getAttribute(($context["field"] ?? null), "markdown", array())) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 15
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFunction($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "text", array())));
            } else {
                // line 17
...
", "forms/fields/spacer/spacer.html.twig", "C:\\xampp\\htdocs\\Davita\\grav-admin\\user\\plugins\\form\\templates\\forms\\fields\\spacer\\spacer.html.twig");
    }
}
